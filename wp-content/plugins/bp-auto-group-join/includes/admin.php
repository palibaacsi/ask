...
if ( ! class_exists( 'BP_Auto_Group_Join_Admin_Page' ) ):
	...
	class BP_Auto_Group_Join_Admin_Page {
		...
		public function ajg_bmt_support_option() {
			...
			echo '<p class="description">' . __( 'Add support for joining users to groups based on their member type. Requires <a target="_blank" href="http://www.buddyboss.com/product/buddypress-member-types/">BuddyPress Member Types</a>.', 'bp-auto-group-join' ) . '</p>';
		}
