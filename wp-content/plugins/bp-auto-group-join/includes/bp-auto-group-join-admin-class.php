...
if ( ! class_exists( 'BP_Auto_Group_Join_Admin' ) ):
    ...
    class BP_Auto_Group_Join_Admin {
        ...
        public function BP_Auto_Group_Join_Admin() {
            $this->hooks();
        }
        ...
        public function bp_groups_admin_edit_auto_join_member() {
            ...
            $mt_deactivated_msg = sprintf(__('<em>Requires the <a href="%s" target="_blank">Buddypress Member Types plugin</a></em>', 'bp-auto-group-join'), 'http://www.buddyboss.com/product/buddypress-member-types/');
                                ...
                                if( isset($member_types) &!empty($member_types) ):
                                    ...
                                    <ul class="bpaj_member_types">
                                        <?php foreach($member_types as $key => $val): ?>
                                            <li>
                                                <input <?php echo in_array($key, $new_registrations_mt) ? 'checked' : '';?> name="aj_new_registrations_mt[]" id="aj_new_registrations_mt_<?php echo $key;?>" type="checkbox" value="<?php echo $key;?>">
                            ...
                            <div class="bpaj_member_types_wrapper" <?php echo $existing_users_mt_css;?>>
                                ...
                                ?>
                                    <ul class="bpaj_member_types">
                                        <?php foreach($member_types as $key => $val): ?>
                                        <li>
                                            <input <?php echo in_array($key, $existing_users_mt) ? 'checked' : '';?> name="aj_existing_users_mt[]" id="aj_existing_users_mt_<?php echo $key;?>" type="checkbox" value="<?php echo $key;?>">
