...
class AdminPageFramework_Form_View__Resource extends AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToAddStyle() {
        ...
        if ($_sCSSRules) {
            echo "<style type='text/css' id='inline-style-{$_sID}' class='admin-page-framework-form-style'>" . $_sCSSRules . "</style>";
        }
        $_sIECSSRules = $this->_getFormattedInlineStyles($this->oForm->getResources('inline_styles_ie'));
        if ($_sIECSSRules) {
            echo "<!--[if IE]><style type='text/css' id='inline-style-ie-{$_sID}' class='admin-page-framework-form-ie-style'>" . $_sIECSSRules . "</style><![endif]-->";
        }
