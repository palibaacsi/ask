 ...
 * Plugin URI: https://wedevs.com/products/plugins/wp-project-manager-pro/buddypress/
...
if ( is_admin() ) {
    ...
    new WeDevs_Plugin_Update_Checker( plugin_basename( __FILE__ ), 'cpm-buddypress' );
}
...
class CPM_BP {
    ...
    function ban_user_from_subtask( $task_id ) {
        $args      = array( 'post_parent' => $task_id, 'numberposts' => - 1, 'post_type' => 'cpm_sub_task' );
